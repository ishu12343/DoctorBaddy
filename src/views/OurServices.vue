          ...
          <div class="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div class="text-center lg:text-left space-y-4 sm:space-y-6 animate-fade-in">
              ...
              <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
                ...
                <button @click="$router.push('/login?role=patient')" class="btn btn-outline btn-large text-white border-white hover:bg-white hover:text-medical-primary w-full sm:w-auto">
            ...
            <div class="animate-slide-up mt-6 lg:mt-0">
              <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-2xl">
                ...
                <div class="grid grid-cols-2 gap-3 sm:gap-4">
                  <button @click="$router.push('/login?role=patient')" class="bg-white/20 hover:bg-white/30 p-3 sm:p-4 rounded-lg transition-all duration-300 text-center touch-button">
          ...
          <div class="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div class="text-center lg:text-left">
              ...
              <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button @click="$router.push('/login?role=patient')" class="btn bg-white text-medical-primary hover:bg-blue-50 w-full sm:w-auto touch-button">
                  <i class="fas fa-user-plus mr-2 text-sm sm:text-base"></i>
                  Sign Up as Patient
                </button>
                <button @click="$router.push('/login?role=doctor')" class="btn border-white text-white hover:bg-white/10 w-full sm:w-auto touch-button">
